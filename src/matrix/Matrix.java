...
public class Matrix<T>{
    ...
    // the type of the first argument of MatrixTraverseDo must be the same that Matrix data type.
    // the type of the second argument of MatrixTraverseDo must be the same of contextVariable data type.
